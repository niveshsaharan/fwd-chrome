...
The current source/runtime version in this branch is `2.0.3`. There is no build step or test suite in-repo. The checked-in JavaScript files are runtime files loaded directly by Chrome.
